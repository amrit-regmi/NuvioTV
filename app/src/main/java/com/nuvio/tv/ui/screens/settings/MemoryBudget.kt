...
object MemoryBudget {
    ...
    // the floor alone exceeds what those devices can hold.
    ...
    /** Hard chunk-size ceiling for this device tier; binds the settings slider, the budget-derived max, and the value used at playback. */
